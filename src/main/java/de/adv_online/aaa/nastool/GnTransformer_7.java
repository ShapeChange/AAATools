 ...
 *
 * (c) 2009-2023 Arbeitsgemeinschaft der Vermessungsverwaltungen der
...
public class GnTransformer_7 implements Transformer {
	...
	/**
	 * Es gibt einige Sonderregeln in den NAS Encoding Rules. Daher erfolgt eine 
	...
	public void transform() throws ShapeChangeAbortException {
		...
		helper.prepareModel("GN_Geographische Informationen","NAS-GN");
