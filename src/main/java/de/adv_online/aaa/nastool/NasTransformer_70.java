...
public class NasTransformer_70 implements Transformer {
	...
	public void transform() throws ShapeChangeAbortException {
		...
		if (!helper.aaaVersion.startsWith("7.0")) {
    		result.addFatalError("Das AAA-Anwendungsschema ist von der falschen Version. Erwartet wurde die Version 7.0, gefunden wurde die Version "+helper.aaaVersion);
