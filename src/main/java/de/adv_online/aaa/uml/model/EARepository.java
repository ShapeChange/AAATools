...
//    private String fullName(Package pkg, String pathToPackage) {
//	return (StringUtils.isBlank(pathToPackage) ? "" : pathToPackage)
//		+ StringUtils.defaultIfBlank(pkg.GetName(), NO_NAME);
//    }

//    private String fullName(Element elmt, String pathToElement) {
//	return (StringUtils.isBlank(pathToElement) ? "" : pathToElement)
//		+ StringUtils.defaultIfBlank(elmt.GetName(), NO_NAME);
//    }
