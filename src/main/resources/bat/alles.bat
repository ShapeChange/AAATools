...
java -jar AAATools-${project.version}.jar -c "Konfigurationen/AAAKatalog-BR-3.0.1-SCXML.xml" 
java -jar AAATools-${project.version}.jar -c "Konfigurationen/AAAKatalog-GN-1.0.0-SCXML.xml" 
...
java -jar AAATools-${project.version}.jar -c "Konfigurationen/NAS-BR-3.0.1.xml" 
java -jar AAATools-${project.version}.jar -c "Konfigurationen/NAS-GN-1.0.0.xml" 
