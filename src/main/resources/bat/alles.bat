...
java -jar AAATools-${project.version}.jar -c "Konfigurationen/AAAKatalog-BR-3.0.0-SCXML.xml" 
...
java -jar AAATools-${project.version}.jar -c "Konfigurationen/NAS-BR-3.0.0.xml" 
