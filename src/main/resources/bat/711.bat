...
java -jar AAATools-${project.version}.jar -c "Konfigurationen/AAAKatalog-LN-1.0.1-SCXML.xml" 
...
java -jar AAATools-${project.version}.jar -c "Konfigurationen/NAS-LN-1.0.1.xml" 
java -jar AAATools-${project.version}.jar -c "Konfigurationen/NAS-AK-1.0.0.xml" 
java -jar AAATools-${project.version}.jar -c "Konfigurationen/NAS-7.1.1.xml"
